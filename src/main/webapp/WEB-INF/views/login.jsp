			        ...
			        <div id="loginBox" style="background-color: rgba(255, 255, 255, 0.1);">
			            ...
			            <div id="inputBox" style="font-weight: bold;">
			                ...
			                <div class="button-login-box" >
			                    <button type="submit" class="btn btn-primary btn-xs" style="width:47%">로그인</button>
			                    <button type="button" class="btn btn-secondary btn-xs" style="width:47%" onclick="location.href='account_create'">회원가입</button>
			                </div>
			            </div>
