	...
	<div class="container-fluid"
		...
		<header class="container text-center"
			...
			<div class="row">
				<!-- 로고 -->
				<div class="col-3">
					<button class="btn" type="button" onclick="location.href='/Galphi/index'">
				...
				<div class="col-6 pt-5">
					<br/>
					<form class="form-control form-control-sm d-flex" action="list" name="Search"
				...
				<ul class="d-flex nav nav-tabs rounded-pill" style="border: none;">
					<li class="nav-item dropdown"
						...
						<ul class="dropdown-menu" style="opacity: 0.8">
							<li style="font-family: 'Nanum Myeongjo', serif;">
								<a class="dropdown-item" href="list?list=Novel">
								<span style="color: #6D4C3D;">소설</span></a></li>
							<li style="font-family: 'Nanum Myeongjo', serif;">
								<a class="dropdown-item" href="list?list=Develop">
								<span style="color: #6D4C3D;">자기계발</span></a></li>
							<li style="font-family: 'Nanum Myeongjo', serif;">
								<a class="dropdown-item" href="list?list=It">
								<span style="color: #6D4C3D;">IT/컴퓨터</span></a></li>
							<li style="font-family: 'Nanum Myeongjo', serif;">
								<a class="dropdown-item" href="list?list=Child">
								<span style="color: #6D4C3D;">아동</span></a></li>
							<li style="font-family: 'Nanum Myeongjo', serif;">
								<a class="dropdown-item" href="list?list=History">
									<span style="color: #6D4C3D;">역사</span>
								</a>
							</li>
						</ul>
					</li>
				...
				<div class="container" style="font-family: 'Nanum Myeongjo', serif;">
					<div class="py-3">
						<div class="d-inline">
							...
							<form class="d-inline text-center align-middle" action="list">
					...
					<div id="best" class="carousel slide" data-bs-ride="carousel">
						<div class="carousel-inner justify-content-center">
							...
							<div class="carousel-item active justify-content-evenly">
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=98'">
									<img src="./images/98.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=90'">
									<img src="./images/90.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=91'">
									<img src="./images/91.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=94'">
									<img src="./images/94.jpg" alt="..." style="height: 200px;">
								</a>
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=95'">
									<img src="./images/95.jpg" alt="..." style="height: 200px;">
								</a>
							</div>
							<div class="carousel-item justify-content-evenly">
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=84'">
									<img src="./images/84.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=85'">
									<img src="./images/85.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=86'">
									<img src="./images/86.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=96'">
									<img src="./images/96.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=97'">
					...
					<div id="recommend" class="carousel slide" data-bs-ride="carousel">
						<div class="carousel-inner justify-content-center">
							...
							<div class="carousel-item active justify-content-evenly">
								...
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=89'">
									<img src="./images/89.jpg" alt="..." style="height: 200px;">
								</a>
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=16'">
									<img src="./images/16.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=15'">
									<img src="./images/15.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=4'">
									<img src="./images/4.jpg" alt="..." style="height: 200px;">
								</a>
							</div>
							<div class="carousel-item justify-content-evenly">
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=73'">
									<img src="./images/73.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=85'">
									<img src="./images/85.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=72'">
					...
					<div id="new" class="carousel slide" data-bs-ride="carousel">
						<div class="carousel-inner justify-content-center">
							...
							<div class="carousel-item active justify-content-evenly">
								...
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=71'">
									<img src="./images/71.jpg" alt="..." style="height: 200px;">
								</a>
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=70'">
									<img src="./images/70.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=85'">
									<img src="./images/85.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=78'">
									<img src="./images/78.jpg" alt="..." style="height: 200px;">
								</a>
							</div>
							<div class="carousel-item justify-content-evenly">
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=42'">
									<img src="./images/42.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=44'">
									<img src="./images/44.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=69'">
									<img src="./images/69.jpg" alt="..." style="height: 200px;">
								</a>
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=43'">
									<img src="./images/43.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=81'">
									<img src="./images/81.jpg" alt="..." style="height: 200px;">
								</a>
							</div>
							<div class="carousel-item justify-content-evenly">
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=80'">
									<img src="./images/80.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=68'">
									<img src="./images/68.jpg" alt="..." style="height: 200px;">
								</a>
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=91'">
									<img src="./images/91.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=76'">
									<img src="./images/76.jpg" alt="..." style="height: 200px;">
								</a> 
								<a class="mx-5" onclick="location.href='selectByISBN?ISBN=88'">
