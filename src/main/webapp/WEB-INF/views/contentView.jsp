...
<%@page import="com.tjoeun.Galphi.vo.BookCommentList"%>
	...
	<div class="container-fluid"
		...
		<main class="container text-center pt-1"
			...
			<div class="container" style="font-family: 'Gowun Dodum', sans-serif;">
				<form class="m-3" action="insertcommentOK" method="post" name="commentForm">
						...
						<tr>
							<td class="clearfix p-2" colspan="4">
								...
								<div class="d-inline p-3 align-middle">
									<b class="d-inline-flex float-left">${co.nick}</b>
									<small class="ml-3">
									...
									<button
										...
										title="후기수정"
										onclick="location.href='updatecommentOK?idx=${co.idx}&coscore=${co.score}&avg=${avg}&size=${comment.size()}'">
									...
									<button
										...
										title="후기삭제"
										onclick="location.href='deletecommentOK?idx=${co.idx}&ISBN=${co.ISBN}&coscore=${co.score}&avg=${avg}&size=${comment.size()}'">
					...
					<table style="width: 700px; margin-left: auto; margin-right: auto;">
						...
						<!-- 댓글 입력 -->
						<tr>
							<th class="align-middle text-center" style="width: 100px; font-weight: bold;">
