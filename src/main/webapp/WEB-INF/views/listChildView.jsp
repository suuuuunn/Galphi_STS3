							...
							<td class="align-middle text-center" colspan="5">
								...
								<c:if test="${bookCategoryList.currentPage > 1}">
									<button 
										...
										type="button" 
										title="첫 페이지로 이동합니다."
										onclick="location.href='list?list=Child&currentPage=1'"
									>처음</button>
								</c:if>
								<c:if test="${bookCategoryList.currentPage <= 1}">
									<button 
								...
								<c:if test="${bookCategoryList.startPage > 1}">
									<button
										...
										onclick="location.href='list?list=Child&currentPage=${bookCategoryList.startPage - 1}'"
									>이전</button>
								</c:if>
								<c:if test="${bookCategoryList.startPage <= 1}">
									<button
								...
								<c:if test="${bookCategoryList.currentPage != i}">
									<button
										class="button button1"
										type="button"
										onclick="location.href='list?list=Child&currentPage=${i}'"
									>${i}</button>
								</c:if>
								...
								<c:if test="${bookCategoryList.endPage < bookCategoryList.totalPage}">
									<button
										...
										onclick="location.href='list?list=Child&currentPage=${bookCategoryList.endPage + 1}'"
									>다음</button>
								</c:if>
								...
								<c:if test="${bookCategoryList.currentPage < bookCategoryList.totalPage}">
									<button
										...
										onclick="location.href='list?list=Child&currentPage=${bookCategoryList.totalPage}'"
									>마지막</button>
								</c:if>
							</td>
					 	 </tr>	
